...
We use a random forest to regress *gestational_age* onto the other variables (the same used as in the main analysis). In comparison to the abysmal predictive accuracy of the logistic regression model ($85\%$, which is barely better than a trivial classifier in this context), the random forest model correctly classifies $95.5\%$ of the cases over the training data. While there could be overffiting here, this is inconsequential in the interpretation of the following analysis.
