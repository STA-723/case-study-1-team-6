...
The estimates in the tails should be understood with care, but there is a clinically significant trend and effect.

Careful with wrong model: the results summarize one interesting aspect of the data, but do not mean much about the nature of things and the "existence" of a dde or pcb effect.
